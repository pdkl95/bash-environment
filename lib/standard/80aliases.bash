...
alias rmshred="shred --remove --zero --verbose"
...
alias ltm="ll -t  --reverse"        # sort by MTIME, most recent last
alias ltc="ll -tc --reverse"        # sort by CTIME, most recent last
alias lta="ll -tu --reverse"        # sort by ATIME, most recent last

# most commonly used time sort
alias lt="ltm"
...
is_cmd iftop && alias iftop='xtitle "iftop: wan0 on $(hostname -f)" -- sudo iftop -i wan0 -P'
is_cmd iftop && alias iotop="xtitle_cmd_on_host sudo iotop"

if is_cmd htop ; then
    alias _top='xtitle_cmd_on_host top'
    alias htop='xtitle_cmd_on_host sudo htop'
    alias top="htop"
else
    alias _top='xtitle_cmd_on_host top'
    alias top="_top"
...
is_cmd pwgen      && alias pwgen="command pwgen --secure --no-vowels --ambiguous --capitalize --numerals"
